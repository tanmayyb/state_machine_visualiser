class arrow {
  constructor(start_node, origin, cp1, cp2, end_node, insertion, text) {
    this.cp_list = []
  ...
  // Used to draw shape of arrows using bezier curve theory in p5.js
  draw_bcurve() {
    noFill()
    beginShape()
  ...
  // Used to draw triangle for the head or arrows
  draw_triangle() {
    push()
  ...
  // Update the connected ends of the arrow
  update_endpoints() {
